...
<head>
  ...
  <title>DBI - Digital Bank of India</title>
</head>

<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark ">
    <a class="navbar-brand" href="dbi.php">DBI</a>
  ...
  <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="https://source.unsplash.com/1600x500/?bank,cash" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
          <h5>World best Bank</h5>
          <p>We believe in high security and secure transactions.</p>
        </div>
      </div>
      <div class="carousel-item">
        <img src="https://source.unsplash.com/1600x500/?staff,view ,crowd,money" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
          <h5>Large Network</h5>
          <p>We build the trust you want.</p>
        </div>
      </div>
      <div class="carousel-item">
        ...
        <div class="carousel-caption d-none d-md-block">
          <h5>Customer Base</h5>
          <p>You people are important for us as we are.</p>
        </div>
      </div>
    </div>
  ...
  <div class="container mt-3  text-center">
    <h1>DIGITAL BANK OF INDIA</h1>
    <h3>Your privacy-our concern</h3>
    <br>

  </div>
  <div class="container text-center  "><button type="button" class="btn btn-danger"> <a href="contact.php"
        style="text-decoration: none; color: #f0ffff;">Enquire Now</a></button>
  </div>
  ...
  <footer>
    <span>Created by <a href="#">Ashish Madan</a> | <span class="far fa-copyright"></span> 2020 All rights
      reserved.</span>
  </footer>
