...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark ">
        <a class="navbar-brand active" href="dbi.php">DBI</a>
    ...
    <div class="container mt-3 text-center">
        ...
        <br>
        <img src="images/maddy.jpg" alt="" height="300px" width="300px">
    </div>
    <div class="container text-center "><button type="button" class="btn btn-danger my-4">Owner</button>
    </div>
