...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark ">
        <a class="navbar-brand active" href="dbi.php">DBI <i class="fa fa-university" aria-hidden="true"></i></a>
    ...
    <div class="container text-center "><button type="button" class="btn btn-danger my-4">Ashish Madaan - Owner</button>
    </div>
