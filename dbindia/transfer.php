...
<head>
  ...
  <title>DBI - Transfer Money</title>
</head>
    ...
    if (isset($_POST['transfer'])) {
        ...
        if($to_acc != 0){
            ...
            if($transfer_amt <= $row_customer['balance']) {
                ...
                $insert_transfer = "insert into transfers (transfer_date, from_acc, from_ acc_name, to_acc, transfer_amt, transfer_msg) values ('$transfer_date', $from_acc, '$from_acc_name', $to_acc, $transfer_amt, '$transfer_msg')";
